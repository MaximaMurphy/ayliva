        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          <div>
            ...
            <p className="text-gray-300 mb-6">
              2010'dan beri lüks ve kişisel bakım odaklı istisnai güzellik hizmetleri sunuyoruz.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <span className="text-gray-300">Güzellik Caddesi No: 123, Moda, İstanbul</span>
              </li>
              <li className="flex items-center">
                <Phone className="mr-3 text-red-600" size={18} />
                <a href="tel:+902123456789" className="text-gray-300 hover:text-red-600 transition-colors duration-300">
                  0212 345 67 89
                </a>
              </li>
              <li className="flex items-center">
                <Mail className="mr-3 text-red-600" size={18} />
                <a href="mailto:info@aylivasalon.com" className="text-gray-300 hover:text-red-600 transition-colors duration-300">
