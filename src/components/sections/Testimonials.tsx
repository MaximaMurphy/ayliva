  ...
  const testimonials = [
    {
      ...
      quote: "Elegance Güzellik Salonu saç bakım rutinime yeni bir boyut kattı. Ekip inanılmaz yetenekli ve her zaman kendimi özel hissettiriyor. Saçlarımı başka kimseye emanet edemem!",
      rating: 5,
    ...
    },
    {
      ...
      name: "Mehmet D.",
      role: "Sadık Müşteri",
      quote: "3 yılı aşkın süredir Elegance'a geliyorum ve hizmet kalitesi her zaman üst düzeyde. Personel arkadaş canlısı, profesyonel ve yaptıkları işte gerçekten yetenekli.",
      rating: 5,
    ...
    },
    {
      ...
      name: "Zeynep K.",
      role: "İlk Kez Gelen",
      quote: "Saçım konusunda çok titiz biri olarak yeni bir salonu denemek konusunda endişeliydim. Elegance tüm beklentilerimi aştı! Stilistim istediğimi dinledi ve mükemmel sonuç verdi.",
      rating: 5,
